...
class WinApp(QWidget):
    ...
    def initUI(self):
        ...
        lblsize = QLabel(self)
        lblsize.setFont(QFont('궁서체', 20)) # 폰트와 폰트사이즈
        lblsize.setStyleSheet('Color: #000000;')
